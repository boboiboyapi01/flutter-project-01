...
class FaceRecognitionLogic extends StatefulWidget {
  final String userId; // ID akun user untuk cek database
  const FaceRecognitionLogic({super.key, required this.userId});

  @override
  State<FaceRecognitionLogic> createState() => _FaceRecognitionLogicState();
}

class _FaceRecognitionLogicState extends State<FaceRecognitionLogic> {
